...
export const sites = pgTable('sites', {
  ...
  facilityType: pgFacilityTypeEnum().notNull().default(sitesFieldDefaultValues.facilityType),
  status: pgSiteStatusEnum().notNull().default(sitesFieldDefaultValues.status),
  ...
  dataSubmissionStatus: pgDataSubmissionStatusEnum().notNull().default(sitesFieldDefaultValues.dataSubmissionStatus),
