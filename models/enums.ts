...
function createZodEnumWithMessage<T extends [string, ...string[]]>(values: T): z.ZodEnum<T> {
...
export const UserRoleEnum = createZodEnumWithMessage(['Sponsor', 'Investigator', 'Coordinator', 'Monitor', 'Patient', 'Nurse']);
...
export const AuditEntityType = createZodEnumWithMessage(['Trial', 'Patient', 'Visit', 'AdverseEvent'])
